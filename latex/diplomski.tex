...
\zahvala{Ovaj je rad posvećen Marici i Perici za sve ispečene palačinke i kasnonoćne vožnje da im jednog dana ovakav pametan sustav zalijeva tikvice i lovor višnje.}
...
\title{Sustav za udaljeni nadzor u poljoprivredi temeljen na platformi ESP32-C3 i AWS-uslugama}
\begin{sazetak}
U ovom radu implementiran je IoT sustav za preciznu poljoprivredu temeljen na razvojnom sustavu ESP32-C3-DevKitM-1 i platformi za računarstvo u oblaku AWS. Na razvojni je sustav spojena senzorska mreža za praćenje različitih poljoprivrednih uvjeta. Korištena je programska biblioteka ESP-AWS-IoT koja omogućuje povezivanje ugradbenog sustava s AWS oblakom putem Wi-Fi mreže. Korišten je protokol MQTT za prijenos podataka s uređaja na platformu u oblaku. Korištena je baza podataka InfluxDB za pohranu podataka u oblaku. Razvijena je web aplikacija temeljena na aplikaciji Grafana za vizualizaciju prikupljenih podataka. Razvijen je alarmni sustav za obavještavanje o promjeni nadziranih parametara.
